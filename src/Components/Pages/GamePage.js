        ...
        <div className="container">
            <div className="wrapper" style={{ width: 0, height: 0 }}>
                ...
                <div className="total_score_wrapper hide">
                    ...
                    <div className='save_score_container'>
                        <h2 className='save_score_title'>Save your score</h2>
                        <input className='save_username_input' placeholder='Name' maxLength={9}></input>
                        <p className='score_message hide'></p>
                        <button className='save_score_button'>Save</button>
                    </div>
                    <div className="play_again_message"> &#60;Hover over the player to try again&#62;</div>
                </div>
